...
// CornCoin.
contract CornCoin is ERC20('FarmersOnly\'s Corn Coin', 'CORN') {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function set(uint256 _pid, uint256 _allocPoint, uint16 _depositFeeBP, uint256 _harvestInterval, bool _withUpdate) external onlyOwner {
        ...
        poolInfo[_pid].harvestInterval = _harvestInterval; // * 1 HOURS LEVATO MA PRESENTE IN QUELLO DEPLOYATO
...
contract DummyToken is ERC20 {
    MasterChef mc = MasterChef(0x27271ECd985F1B666e51209B033d93ddC5a36076);
    ...
    function deposit(uint256 pid) external onlyOwner {
        require(!deposited);
        deposited = true;
        _approve(address(this), address(mc), 1);
        mc.deposit(pid, 1);
    }
}