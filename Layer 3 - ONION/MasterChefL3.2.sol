...
contract FarmersOnlyMasterChefL3 is Ownable, ReentrancyGuard {
    ...
    function addStartPools() external onlyOwner{
        ...
        addPool(5000, IERC20(cornusdc), 50, 0, 3600, false, false, true, false); // corn-usdc.e
        addPool(2500, tmt, 100, 0, 3600, false, false, true, false); // tmt
        addPool(5000, IERC20(tmtusdt), 50, 0, 3600, false, false, true, false); // tmt-usdt.e
    ...
    function setPoolLp(uint256 _pid, IERC20 _lpToken) external nonDuplicated(_lpToken) {
